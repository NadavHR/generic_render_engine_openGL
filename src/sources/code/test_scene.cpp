...
void TestScene::init() {
    ...
    auto testModelRenderObject = std::shared_ptr<ModelRenderObject>(new DynamicModelRenderObject(mTestModel, glm::vec3(0,0,-5), glm::vec3(0), glm::vec3(1)));
    auto testModelRenderObject2 = std::shared_ptr<ModelRenderObject>(new DynamicModelRenderObject(mTestModel, glm::vec3(1, 1, -4), glm::vec3(1, 0, 0), glm::vec3(1)));
